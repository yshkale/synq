...
export const PrioritySelector = (props: any) => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="w-20 lg:w-fit flex items-center gap-0.5 text-xs text-neutral-600 border border-neutral-200 bg-neutral-100 rounded-md px-2 py-1">
